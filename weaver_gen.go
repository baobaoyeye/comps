...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/baobaoyeye/comps/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/baobaoyeye/comps/Reverser", Method: "Reverse"})}
		},
